...
* [AI Assistant API]({{kib-apis}}group/endpoint-security-ai-assistant-api): Interact with and manage Elastic AI Assistant.
* [Attack discovery API]({{kib-apis}}group/endpoint-security-attack-discovery-api): Generate and manage Attack discoveries.
...
* [Timeline API]({{kib-apis}}group/endpoint-security-timeline-api): Manage, import, and export Timelines.
