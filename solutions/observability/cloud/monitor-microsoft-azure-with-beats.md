...
To collect metrics from Microsoft Azure, use the [{{metricbeat}} Azure module](asciidocalypse://docs/beats/docs/reference/ingestion-tools/beats-metricbeat/metricbeat-module-azure.md). This module periodically fetches monitoring metrics from Microsoft Azure using the [Azure Monitor REST API](https://docs.microsoft.com/en-us/rest/api/monitor/).

::::{warning}
Extra Azure charges on metric queries my be generated by this module. Please see [additional notes about metrics and costs](asciidocalypse://docs/beats/docs/reference/ingestion-tools/beats-metricbeat/metricbeat-module-azure.md#azure-api-cost) for more details.
