...
See the [secure communication with {{es}}](#apm-securing-communication-elasticsearch) guide or [SSL configuration reference](/solutions/observability/apm/apm-server/ssl-tls-output-settings.md) for more information.
...
* [SSL/TLS output settings](/solutions/observability/apm/apm-server/ssl-tls-output-settings.md)
