...
2. Disable the default collection of APM Server monitoring metrics.<br>
    ...
    For more information, see [Monitoring configuration options](/solutions/observability/apm/apm-server/use-internal-collection-to-send-monitoring-data.md#apm-configuration-monitor).
