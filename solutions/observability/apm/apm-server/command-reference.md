...
| [`keystore`](#apm-keystore-command) | Manages the [secrets keystore](/solutions/observability/apm/apm-server/secrets-keystore-for-secure-settings.md). |
...
Manages the [secrets keystore](/solutions/observability/apm/apm-server/secrets-keystore-for-secure-settings.md).
...
See [Secrets keystore](/solutions/observability/apm/apm-server/secrets-keystore-for-secure-settings.md) for more examples.
...
**`--path.config`**
:   Sets the path for configuration files. See the [Installation layout](/solutions/observability/apm/apm-server/installation-layout.md) section for details.

**`--path.data`**
:   Sets the path for data files. See the [Installation layout](/solutions/observability/apm/apm-server/installation-layout.md) section for details.

**`--path.home`**
:   Sets the path for miscellaneous files. See the [Installation layout](/solutions/observability/apm/apm-server/installation-layout.md) section for details.

**`--path.logs`**
:   Sets the path for log files. See the [Installation layout](/solutions/observability/apm/apm-server/installation-layout.md) section for details.
