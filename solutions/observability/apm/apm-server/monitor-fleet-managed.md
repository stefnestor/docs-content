...
1. Install {{metricbeat}} on the same server as {{agent}}. To learn how, see [Get started with {{metricbeat}}](beats://reference/metricbeat/metricbeat-installation-configuration.md). If you already have {{metricbeat}} installed, skip this step.
