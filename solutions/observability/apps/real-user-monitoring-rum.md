...
Real User Monitoring captures user interaction with clients such as web browsers. The [JavaScript Agent](https://www.elastic.co/guide/en/apm/agent/rum-js/{{apm-rum-branch}}) is Elastic’s RUM Agent.
