...
Review the APM [release notes](/release-notes/elastic-apm.md), [breaking changes](https://www.elastic.co/guide/en/observability/current/apm-breaking.html), and {{observability}} [What’s new](https://www.elastic.co/guide/en/observability/current/whats-new.html) content for important changes between your current APM version and this one.
