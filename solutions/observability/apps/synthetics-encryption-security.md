...
All data is encrypted in transit. See [Elastic Agent configuration encryption](/reference/ingestion-tools/fleet/_agent_configuration_encryption.md) for more details.