...
* In all scenarios, using medium sized events. Events include [transactions](transactions.md) and [spans](spans.md).
...
Alternatively or in addition to scaling the APM Server, consider decreasing the ingestion volume. Read more in [Reduce storage](reduce-storage.md).
