...
Then, you can refer to [Tutorial: Customize data retention for integrations](/reference/ingestion-tools/fleet/data-streams-ilm-tutorial.md) to learn how to apply a custom {{ilm-init}} policy to the browser data streams.