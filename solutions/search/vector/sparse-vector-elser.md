...
# Sparse vector (ELSER) [semantic-search-elser]
...
To learn how to optimize space, refer to the [Saving disk space by excluding the ELSER tokens from document source](#save-space) section.
