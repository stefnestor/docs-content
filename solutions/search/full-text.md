...
::::{tip}
If you'd prefer to start with a hands-on example, refer to our [full-text search tutorial](elasticsearch://reference/query-languages/query-dsl/full-text-filter-tutorial.md).
::::
