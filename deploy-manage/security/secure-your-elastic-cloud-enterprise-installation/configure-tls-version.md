...
{{ece}} 2.4.0 and later defaults to minimum TLS version 1.2 with a modern set of cipher suites.

| {{ece}} version | Default minimum TLS version | Default allowed cipher suites |
| --- | --- | --- |
