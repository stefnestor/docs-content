...
2. Enable the {{es}} module in {{metricbeat}} on each {{es}} node.
    ...
    For more information, refer to [{{es}} module](https://www.elastic.co/guide/en/beats/metricbeat/current/metricbeat-module-elasticsearch.html).
