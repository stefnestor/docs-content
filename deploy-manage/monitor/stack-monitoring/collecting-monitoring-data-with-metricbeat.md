...
2. Enable the {{es}} module in {{metricbeat}} on each {{es}} node.
    ...
    For more information, refer to [{{es}} module](asciidocalypse://docs/beats/docs/reference/ingestion-tools/beats-metricbeat/metricbeat-module-elasticsearch.md).
...
6. [Start {{metricbeat}}](asciidocalypse://docs/beats/docs/reference/ingestion-tools/beats-metricbeat/metricbeat-starting.md) on each node.
