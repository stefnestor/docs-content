...
* `xpack.fleet.agentPolicies` policies are needed for {{fleet-server}} and {{agents}} to enroll to. For more information, refer to [](/reference/fleet/create-policy-no-ui.md).
