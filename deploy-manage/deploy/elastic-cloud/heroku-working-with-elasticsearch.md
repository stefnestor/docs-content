...
For more examples, refer to the [document APIs]({{es-apis}}group/endpoint-document). You can also use [clients](/reference/elasticsearch-clients/index.md) to interact with these APIs.
