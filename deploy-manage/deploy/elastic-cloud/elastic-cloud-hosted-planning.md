...
* **{{fleet}} instances**: You should ensure that each Integration Server instance in your cluster has at least 1 GB of RAM. Refer to [Fleet Server scalability](/reference/fleet/fleet-server-scalability.md#scaling-recommendations) for recommendations.
