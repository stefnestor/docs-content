...
* For version 7.x:
    ...
    2. [Log into the Cloud UI](../../deploy/cloud-enterprise/log-into-cloud-ui.md) and [add the S3 repository plugin](https://www.elastic.co/guide/en/cloud-enterprise/current/ece-add-plugins.html) to your cluster.
