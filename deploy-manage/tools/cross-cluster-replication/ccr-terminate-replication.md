...
You can terminate replication with the [unfollow API]({{es-apis}}operation/operation-ccr-unfollow). This API converts a follower index to a standard (non-follower) index.
