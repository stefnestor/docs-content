...
Use the [pause auto-follow pattern API]({{es-apis}}operation/operation-ccr-pause-auto-follow-pattern) to pause auto-follow patterns. Use the [resume auto-follow pattern API]({{es-apis}}operation/operation-ccr-resume-auto-follow-pattern) to resume auto-follow patterns.
