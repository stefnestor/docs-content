...
| {{beats}} | Use {{beats}} data shippers to send operational data to Elasticsearch directly or through Logstash. | [{{beats}} (Serverless)](beats://reference/index.md) <br> [What are {{beats}}?](beats://reference/index.md) <br> [{{beats}} and {{agent}} capabilities](/manage-data/ingest/tools.md)|
