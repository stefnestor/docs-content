...
* Time series data may progress through the descending temperature data tiers (hot, warm, cold, and frozen) according to your performance, resiliency, and data retention requirements.
    ...
    You can automate these lifecycle transitions using [data stream lifecycle](/manage-data/lifecycle/data-stream.md) or custom [{{ilm}}](/manage-data/lifecycle/index-lifecycle-management.md).
