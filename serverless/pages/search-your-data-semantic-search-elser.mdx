...
<div id="semantic-search-elser"></div>
...
To learn how to optimize space, refer to the <DocLink slug="/serverless/elasticsearch/elasticsearch/reference/semantic-search-elser" section="saving-disk-space-by-excluding-the-elser-tokens-from-document-source">Saving disk space by excluding the ELSER tokens from document source</DocLink> section.

<div id="inference-ingest-pipeline"></div>
...
<div id="reindexing-data-elser"></div>
