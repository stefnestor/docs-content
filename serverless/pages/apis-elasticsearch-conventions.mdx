...
Check out <DocLink slug="/serverless/devtools/run-api-requests-in-the-console" />.
...
To get API keys or the Elasticsearch Endpoint (`${ES_URL}`) for a project, refer to <DocLink slug="/serverless/elasticsearch/get-started" />.
