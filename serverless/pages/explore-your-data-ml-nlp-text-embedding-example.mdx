...
<DocLink slug="/serverless/elasticsearch/explore-your-data-ml-nlp/search-compare-text" section="text-embedding">text embedding</DocLink> 
...
<DocLink slug="/serverless/elasticsearch/explore-your-data-ml-nlp/model-reference" section="third-party-text-embedding-models">third-party model reference list</DocLink> 
