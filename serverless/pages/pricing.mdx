...
therefore the cost. Note that Elasticsearch Serverless maintains [minimum compute resource 
Ingest and Search VCUs](https://www.elastic.co/pricing/serverless-search#what-are-the-minimum-compute-resource-vcus-on-elasticsearch-serverless).
