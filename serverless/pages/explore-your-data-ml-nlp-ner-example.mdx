...
<DocLink slug="/serverless/elasticsearch/explore-your-data-ml-nlp/extract-info" section="named-entity-recognition">named entity recognition (NER)</DocLink> 
...
<DocLink slug="/serverless/elasticsearch/explore-your-data-ml-nlp/model-reference" section="third-party-named-entity-recognition-models">third-party model reference list</DocLink> 
