...
<DocLink slug="/serverless/elasticsearch/clients" text="language clients"/> or the
...
<DocLink slug="/serverless/elasticsearch/ingest-data-through-beats" /> or
<DocLink slug="/serverless/elasticsearch/ingest-data-through-logstash" />.
