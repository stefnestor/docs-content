...
We are working on data migration tools! In the interim, you can <<elasticsearch-ingest-data-through-logstash,use Logstash>> with {es} input and output plugins to move data to and from serverless projects.
