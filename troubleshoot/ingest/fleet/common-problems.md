...
A stuck {{agent}} upgrade should be detected automatically, and you can [restart the upgrade](/reference/fleet/upgrade-elastic-agent.md#restart-upgrade-single) from {{fleet}}.
