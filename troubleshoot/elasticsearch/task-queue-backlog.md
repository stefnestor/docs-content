...
For additional tips on how to track and avoid resource-intensive searches, refer to [Avoid expensive searches](high-jvm-memory-pressure.md#reduce-jvm-memory-pressure-setup-searches).
