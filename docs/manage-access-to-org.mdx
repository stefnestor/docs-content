...
description: Add members to your orgnization and projects.
tags: [ 'serverless', 'general', 'organization', 'overview' ]
---

To allow other users to interact with your projects, you must invite them to join your orgnization.
