...
you required ((ml)) for inference or anomaly detection, those VCUs are also 
metered and billed.
...
* **Machine Learning** &mdash; The VCUs used to perform inference, anomaly 
    detection and other ML activities.
