...
title: Aggregations
description: Aggregate and summarize your ((es-serverless)) data.
...
You can run aggregations as part of a <DocLink id="serverlessElasticsearchSearchYourData">search</DocLink> by specifying the <DocLink id="serverlessElasticsearchSearchYourDataTheSearchApi">search API</DocLink>'s `aggs` parameter. The
