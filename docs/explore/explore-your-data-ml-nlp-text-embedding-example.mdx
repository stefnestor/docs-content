...
<DocLink id="serverlessElasticsearchExploreYourDataMachineLearningNlpSearchCompare" section="text-embedding">text embedding</DocLink> 
...
<DocLink id="serverlessElasticsearchExploreYourDataMachineLearningNlpModelRef" section="third-party-text-embedding-models">third-party model reference list</DocLink> 
