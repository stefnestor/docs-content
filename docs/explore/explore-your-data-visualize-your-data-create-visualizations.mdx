...
2. In the **Title** field, enter `Median of bytes`, then click **Save**.
...
2. In the **Title** field, enter `Sum of bytes from large requests`, then click **Save**.
...
2. In the **Title** field, enter `Website traffic`, then click **Save**.
...
2. In the **Title** field, enter `Page views by location and referrer`, then click **Save**.
