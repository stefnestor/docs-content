...
This tutorial uses the same web logs sample data from [Create dashboards](/serverless/elasticsearch/explore-your-data-dashboards).
...
You create panels new panels, which you can access from the dashboard toolbar or the **Visualize Library**, or add panels that are saved in the **Visualize Library**, or search results from <DocLink id="serverlessElasticsearchExploreYourDataDiscoverYourData" section="save-your-search-for-later-use">**Discover**</DocLink>.

**Panels/visualizations added to the **Visualize Library** are avaialbe to all dashboards.** 

To create panels from the dashboard:

1. From the main menu, then click **Dashboard** and select **[Logs] Web Traffic**.

1. Click **Edit** then click **Create visualization**.

1. From the **Avalible fields** drag and drop the data you want to visualize.
...
1. From the main menu, then click **Visualize Library**.
...
1. Under **Save vizualization** enter a **Title**, **Descriptioin**, and decide if you want to save the new panel to an exisitng dashboard, a new dasboard, or to the **Visualize Library**.
...
Add **Text** panels to your dashboard that display important information, instructions, and more. You create **Text** panels using GitHub-flavored Markdown text.
...
Your new text panel displayes on your dashboard. 
...
Your new image panel displayes on your dashboard. 
...
* **More > Download as CSV** &mdash; Downlaods the data as a CSV file. 
