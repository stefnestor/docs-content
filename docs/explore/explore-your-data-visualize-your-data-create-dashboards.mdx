...
To automate ((kib)), you can export dashboards as JSON using the <a href="https://www.elastic.co/guide/en/kibana/current/saved-objects-api-export.html" target="_blank"> Export objects API </a>. It is important to export dashboards with all necessary references.
