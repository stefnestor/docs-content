...
By default some visualization panels have been created for you using the sample data. Go to <DocLink id="serverlessElasticsearchExploreYourDataVisualizations" text="Create visualization" /> to learn about the different visualizations.
