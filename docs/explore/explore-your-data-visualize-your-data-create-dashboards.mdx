...
By default some visualization panels have been created for you using the sample data. Go to [Create visualization](/serverless/elasticsearch/explore-your-data-visualizations) to learn about the different visualizations.  

![dashboard with default visualizations using sample data](images/dashboards/dashboard-example.png)
...
To share the dashboard with a larger audience, click **Share** in the toolbar. For detailed information about the sharing options, refer to [Reporting](https://www.elastic.co/guide/en/kibana/current/reporting-getting-started.html).
