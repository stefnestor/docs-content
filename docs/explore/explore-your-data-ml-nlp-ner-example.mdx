...
<DocLink id="serverlessElasticsearchExploreYourDataMachineLearningNlppExtractInfo" section="named-entity-recognition">named entity recognition (NER)</DocLink> 
...
<DocLink id="serverlessElasticsearchExploreYourDataMachineLearningNlpModelRef" section="third-party-named-entity-recognition-models">third-party model reference list</DocLink> 
