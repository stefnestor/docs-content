...
1. To add the ecommerce sample data from the home page select **Try sample data > Other sample data sets** and under **Sample eCommerce orders** click **Add data**.

2. Click **View data** and select **Discover**.

To create a data view for your own data in Discover, click **Create a data view**.

<DocImage size="l" url="images/discover/discover-create-a-data-view.png" alt="Create a data view" />
