...
1. To add the ecommerce sample data, in the main meny select **Home** > **Try sample data** > **Other sample data sets** and under **Sample eCommerce orders** click **Add data**.

2. Click **View data** and select **Discover**.

To create a data view for your own data in Discover, click **Create a data view**.

!["Create a data view"](images/discover-create-a-data-view.png)
