...
| <DocLink id="serverlessElasticsearchExploreYourDataVisualizeYourData" section="add-context-to-panels">Text</DocLink> | Add context to your panels with **Text**. |
| <DocLink id="serverlessElasticsearchExploreYourDataVisualizeYourData" section="add-image-panels">Image</DocLink> | Personalize your dashboard with a custom image. |
...
You create panels using the editors, which you can access from the dashboard toolbar or the **Visualize Library**, or add panels that are saved in the **Visualize Library**, or search results from <DocLink id="serverlessElasticsearchExploreYourDataDiscoverYourData" section="save-your-search-for-later-use">**Discover**</DocLink>.
