...
In addition to the **Organization owner** and **Billing admin** roles, each project type has a predefined set of roles. This list describes the scope of the different roles per project.
