...
Use the [**Explain API**](((ref))/search-explain.html) {/*  <DocLink id="enElasticsearchReferenceSearchExplain">explain API</DocLink> */} to find out why a specific document matches or doesn’t match a query:
