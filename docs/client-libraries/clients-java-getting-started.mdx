...
description: Set up and use the Java client for ((es-serverless)).
tags: [ 'serverless', 'elasticsearch', 'java', 'how to' ]
status: in review
---

This page guides you through the installation process of the ((es-serverless)) Java 
...
You can add the ((es-serverless)) Java client to your Java project using 
either Gradle or Maven.

### Using Gradle

You can install the ((es-serverless)) Java client as a Gradle dependency:
...
You can install the ((es-serverless)) Java client as a Maven dependency, add
