...
You can add the Elasticsearch Serverless Java client to your Java project using 
...
follows the Elasticsearch JSON API. Lambda expressions allows you to be guided 
