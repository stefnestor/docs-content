...
description: Set up and use the Go client for ((es-serverless)).
tags: [ 'serverless', 'elasticsearch', 'go', 'how to' ]
status: in review
---

<DocBadge template="technical preview" />
This page guides you through the installation process of the ((es-serverless)) Go 
...
You can install the ((es-serverless)) Go client with the following 
commands:
