...
description: Set up and use the Node.js client for ((es-serverless)).
...
This page guides you through the installation process of the ((es-serverless)) Node.js 
...
You can install the ((es-serverless)) Node.js client with the following 
commands:
