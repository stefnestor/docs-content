...
description: Set up and use the Python client for ((es-serverless)).
tags: [ 'serverless', 'elasticsearch', 'python', 'how to' ]
status: in review
---

This page guides you through the installation process of the ((es-serverless)) Python 
...
You can install the ((es-serverless)) Python client with the following 
commands:
...
client = Elasticsearch(
    "https://...",  # Your project's Cloud URL
