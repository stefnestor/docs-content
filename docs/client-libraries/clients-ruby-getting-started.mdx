...
You can install the Elasticsearch Serverless Ruby client from GitHub's 
...
You can copy the code from your Elasticsearch Serverless deployment home page.

<DocImage url="images/serverless-api-key.gif" alt="Create and copy Apy Key"/>
