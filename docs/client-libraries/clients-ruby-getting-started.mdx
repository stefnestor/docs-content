...
description: Set up and use the Ruby client for ((es-serverless)).
...
* To use the `elasticsearch-serverless` gem, you must have an API key and Elasticsearch Endpoint for an ((es-serverless)) project.
...
You can install the ((es-serverless)) Ruby Client from RubyGems:
...
The code examples in this section use the Ruby console. To set up the console, <DocLink id="serverlessElasticsearchRubyGettingStarted" section="running-a-ruby-console" text="Running a Ruby console" />.
</DocCallOut>
