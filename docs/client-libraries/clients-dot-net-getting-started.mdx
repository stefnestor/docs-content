...
title: Getting started with the Serverless .NET client
...
.NET client, shows you how to initialize the client, and how to perform basic
...
You can install the ((es-serverless)) .NET client with the following command:
