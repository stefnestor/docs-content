...
<DocLink id="serverlessElasticsearchExploreYourDataAggregations" text="aggregations" />
...
[stats aggregation](((ref))/search-aggregations-metrics-stats-aggregation.html) {/* <DocLink id="enElasticsearchReferenceSearchAggregationsMetricsStatsAggregation">stats aggregation</DocLink> */}  
