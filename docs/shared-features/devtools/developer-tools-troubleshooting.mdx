...
For `keyword` fields, you can use a `terms` aggregation to retrieve the field's 
most common values:
...
For numeric fields, you can use [stats aggregation](((ref))/search-aggregations-metrics-stats-aggregation.html) 
{/* <DocLink id="enElasticsearchReferenceSearchAggregationsMetricsStatsAggregation">stats aggregation</DocLink> */}  
