...
![A world map with country and revenue layers](images/maps/sample_data_ecommerce_map.png)
...
![An animated city map of Portland with changing bus locations](images/maps/timeslider_map.gif)
...
Add your map to a <DocLink id="serverlessElasticsearchExploreYourDataDashboards" text="dashboard"/> and view your geospatial data alongside bar charts, pie charts, tag clouds, and more.
...
![A dashboard with a map, bar chart, and tag cloud](images/maps/embed_dashboard_map.jpeg)
