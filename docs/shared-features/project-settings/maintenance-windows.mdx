...
If you turn on **Filter alerts**, you can add filters to refine the scope of the maintenance window.
...
Note that you can select only a single category when you turn on filters.
