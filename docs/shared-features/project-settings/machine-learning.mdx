...
description: View, export, and import machine learning jobs and models.
...
For example, if you used APIs to create your jobs, you can wait for automatic synchronization to create the saved objects.
Alternatively, click **Synchronize saved objects**.

## Export and import jobs

You can export and import your ((ml)) job and ((dfeed)) configuration details, for example from your test environment to production environment.
