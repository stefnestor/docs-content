---
id: serverlessSettingsActionConnectors
slug: /serverless/settings/action-connectors
title: Connectors
...
<DocRelatedArticles
  items={
    [
       {
        "title": "D3 Security",
        "description": "Send a request to D3 Security.",
      ...
      },
      {
        ...
        "href": "https://www.elastic.co/guide/en/kibana/current/gen-ai-action-type.html",
        "target": "_blank"
      },
      {
        "title": "IBM Resilient",
      ...
      {
        "title": "Swimlane",
        "description": "Create an incident in Swimlane.",
        "href": "https://www.elastic.co/guide/en/kibana/current/swimlane-action-type.html",
        "target": "_blank"
        },
      {
        "title": "Tines",
        "description": "Send events to a Tines Story.",
      ...
      {
        "title": "xMatters",
        "description": "Send actionable alerts to on-call xMatters resources.",
...
{/* 
<div id="connector-management"></div> */}
{/* 
## Managing connectors
...
<div id="creating-new-connector"></div>
...
<div id="importing-and-exporting-connectors"></div>
...
<div id="monitoring-connectors"></div>
