...
Annotation groups give you the option to mark points on a visualization with events, such as a deployment, to help track performance. These annotations can be reused across multiple visualization panels. 