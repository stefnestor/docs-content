...
import DeployNlpModelWidget from './tab-widgets/semantic-search/deploy-nlp-model/widget.mdx'
import FieldMappingsWidget from './tab-widgets/semantic-search/field-mappings/widget.mdx'
import GenerateEmbeddingsWidget from './tab-widgets/semantic-search/generate-embeddings/widget.mdx'
import SearchWidget from './tab-widgets/semantic-search/search/widget.mdx'
import HybridSearchWidget from './tab-widgets/semantic-search/hybrid-search/widget.mdx'
...
* Tutorials:
    * <DocLink id="serverlessElasticsearchSemanticSearchElser">Semantic search with ELSER</DocLink>
