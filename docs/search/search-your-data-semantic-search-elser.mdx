...
To learn how to optimize space, refer to the <DocLink id="serverlessElasticsearchSemanticSearchElser" section="saving-disk-space-by-excluding-the-elser-tokens-from-document-source">Saving disk space by excluding the ELSER tokens from document source</DocLink> section.
