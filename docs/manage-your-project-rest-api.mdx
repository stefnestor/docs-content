...
You can manage serverless projects using the Elastic Cloud REST API. This API allows you to create, update, and delete projects, as well as manage project features and usage.
...
You must provide the API key in all API requests in the `Authorization` header as follows,:
...
1. [Create and API key](https://www.elastic.co/guide/en/cloud/current/ec-api-authentication.html).
...
You can store the project ID as an environment variable for the following requests:
