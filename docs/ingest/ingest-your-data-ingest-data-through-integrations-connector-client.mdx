...
connectors:
  -
    ...
    api_key: <CONNECTOR_API_KEY> # Optional defaults to elasticsearch.api_key
```

**Step 3: Run the Docker image**

Use the following command, substituting the values in curly braces.
...
-c /config/config.yml # Path to your configuration file
```
