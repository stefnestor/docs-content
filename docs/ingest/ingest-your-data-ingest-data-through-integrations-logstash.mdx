...
and output the data to ((es)) using the ((ls)) [Elasticsearch output plugin](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v11.18.0-plugins-outputs-elasticsearch.html).
