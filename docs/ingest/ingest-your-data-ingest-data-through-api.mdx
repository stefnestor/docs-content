...
<DocLink id="serverlessElasticsearchIngestDataThroughIntegrationsBeats" />, 
<DocLink id="serverlessElasticsearchIngestDataThroughIntegrationsLogstash" />, or 
<DocLink id="serverlessElasticsearchIngestDataThroughIntegrationsConnectorClient" />.
