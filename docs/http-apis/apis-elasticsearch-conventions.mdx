...
Check out <DocLink id="serverlessDevtoolsRunApiRequestsInTheConsole" />.
...
To get API keys or the Elasticsearch Endpoint (`${ES_URL}`) for a project, refer to <DocLink id="serverlessElasticsearchGetStarted" />.
