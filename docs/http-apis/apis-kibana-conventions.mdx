...
description: The ((kib)) REST APIs have conventions for authentication and headers.
...
{/* MISSING LINK: For information about API keys, refer to <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>  <DocLink id="enKibanaApiKeys">API keys</DocLink>. */}
...
{/* MISSING LINKS:
<DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>  <DocLink id="enKibanaSettings" section="settings-xsrf-allowlist">`server.xsrf.allowlist`</DocLink>
<DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge> <DocLink id="enKibanaSettings" section="settings-xsrf-disableProtection">`server.xsrf.disableProtection`</DocLink>
*/}
