...
- **Index lifecycle management (((ilm-init)))** is not available, in favor of **<DocLink id="serverlessIndexManagement" section="manage-data-streams" 
text="data stream lifecycle"/>**. 
  ...
  <br/>
- **Watcher** is not available, in favor of **<DocLink id="serverlessElasticsearchExploreYourDataAlerting" text="Kibana Alerts"/>**. 
...
- Certain APIs, API parameters, index, cluster and node level settings are not available. Refer to our 
  <DocLink id="serverlessElasticsearchHttpApis" text="REST API references"/> for a list of available APIs.
...
For serverless technical preview limitations, refer to <DocLink id="serverlessTechnicalPreviewLimitations" text="Technical preview limitations"/>. 
