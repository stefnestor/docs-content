...
<DocCallOut>
  This example uses ((es)) APIs to ingest data. If you'd prefer to upload a file using the UI, refer to <DocLink id="serverlessElasticsearchIngestDataFileUpload" />.
</DocCallOut>
