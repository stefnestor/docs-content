...
title: Get started
description: Get started with Elasticsearch Serverless in a few steps
tags: [ 'serverless', 'elasticsearch', 'getstarted', 'overview' ]
status: publish ready
---

Follow along to set up your Elasticsearch Serverless project and get started with some sample documents.
Then, choose how to continue with your own data.

## Create project

Use your Elastic Cloud account to create a fully-managed Elasticsearch Serverless project:

1. Navigate to [cloud.elastic.co](https://cloud.elastic.co/) and create a new account or log in to your existing account.

1. Within **Fully-managed projects**, choose **Create project**.

1. Choose the **Elasticsearch Serverless** project type.
...
You should now see the getting started screen within your Elasticsearch project, and you're ready to create an API key.

## Create key

Create an API key, which will enable you to access the Elasticsearch API to ingest and search sample data.

1. Within the **Get started with Elasticsearch** page, scroll to **Prepare an API Key** and select **New**.

1. Within **Create an API key**, enter a name for your key and its expiration.
...
You'll send all Elasticsearch API requests to this URL.

1. Scroll to **Copy your connection details**.

1. Find the value for **Cloud URL**.
...
Within your terminal, assign these values to the environment variables `ES_URL` and `API_KEY`.
...
Congratulations!
You've set up an Elasticsearch Serverless project, and you've ingested and searched some sample data.
...
By creating a data view, you can explore data using several UI tools: Discover, Dashboard, or the Visualize Library.
Or, use Elasticsearch aggregations to explore your data using the API.

See:

- <DocLink id="serverlessElasticsearchExploreYourData" />

### Build

Ready to build your own solution?

Learn more details about ingestion APIs and additional ingestion tools that help you send and sync data from various sources.
And learn more about the search API and its query DSL.

See:

- <DocLink id="serverlessElasticsearchIngestYourData" />
- <DocLink id="serverlessElasticsearchSearchYourData" />
- <DocLink id="serverlessElasticsearchSearchYourDataTheSearchApi" />
- <DocLink id="serverlessElasticsearchHttpApis" />
