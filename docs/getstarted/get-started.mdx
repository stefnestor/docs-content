...
Use your Elastic Cloud account to create a fully-managed ((es-serverless)) project:
...
You should now see the getting started screen within your ((es)) project, and you're ready to create an API key.

## Create key

Create an API key, which will enable you to access the ((es)) API to ingest and search sample data.

1. Within the **Get started with ((es))** page, scroll to **Prepare an API Key** and select **New**.
...
Or, use ((es)) aggregations to explore your data using the API.
