...
1. Log in to your Elastic Cloud account and select **Create project** from the **Fully-managed projects** page.

   ![Create your project](images/gs-create-project.png)

2. Choose **Elasticsearch Serverless** solution.
...
3. Edit your project settings.
   ...
   **Region** -- The cloud platform’s region where your project will live. The region should be as close as possible to the location of your data.
   ...
   You can also see [the pricing details](https://cloud.elastic.co/pricing) on how you consume Elasticsearch Serverless.
