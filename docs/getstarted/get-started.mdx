...
1. On the **Get started with ((es))** page, scroll to **Prepare an API Key** and select **New**.
...
By creating a data view, you can explore data using several UI tools, such as Discover or Dashboards.
...
Learn more details about ways you send and sync data to ((es)) from various sources.
