...
To learn how your rules and alerts are affected by using the [logsdb index mode](../../../manage-data/data-store/index-types/logsdb.md), refer to [*Using logsdb index mode with {{elastic-sec}}*](../../../solutions/security/detect-and-alert/using-logsdb-index-mode-with-elastic-security.md).
