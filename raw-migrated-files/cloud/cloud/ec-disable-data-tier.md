# Disable an Elasticsearch data tier [ec-disable-data-tier]
...
## Non-searchable snapshot data tier [ec-disable-non-searchable-snapshot-data-tier]
...
* [Configure index management](../../../manage-data/lifecycle/index-lifecycle-management.md)
...
3. Determine which shards need to be moved.
    ...
    :::{image} ../../../images/cloud-ec-ce-remove-tier-filtered-cat-shards.png
...
## Searchable snapshot data tier [ec-disable-searchable-snapshot-data-tier]
...
2. Capture a comprehensive list of index and searchable snapshot names.
    ...
    1. The index name of the searchable snapshots may differ based on the data tier. If you intend to disable the cold tier, then perform the following request with the `restored-*` prefix. If the frozen tier is the one to be disabled, use the `partial-*` prefix.
        ...
        :::{image} ../../../images/cloud-ec-ce-remove-tier-filter-snapshot-indices.png
...
4. Remove the aliases that were applied to searchable snapshots indices. Use the index prefix from step 2.
    ...
    :::{image} ../../../images/cloud-ec-ce-remove-tier-remove-alias.png
...
5. Restore indices from the searchable snapshots.
    ...
    1. Follow the steps to [specify the data tier based allocation inclusion rules](../../../manage-data/lifecycle/index-lifecycle-management.md#ec-update-data-tier-allocation-rules).
    ...
    4. Optionally, specify the desired number of replica shards.
        ...
        :::{image} ../../../images/cloud-ec-ce-remove-tier-restore-snapshot.png
...
9. Delete the searchable snapshots by following these steps:
    ...
    3. Bulk select the snapshots and delete them
        ...
        :::{image} ../../../images/cloud-ec-ce-remove-tier-remove-snapshots.png
