# Migrate internal indices [ec-migrate-data-internal]
...
To reindex internal indices from a remote cluster, you can follow the same steps that you use to reindex regular indices when you [migrate your Elasticsearch data indices](../../../manage-data/migrate.md#ec-reindex-remote).
