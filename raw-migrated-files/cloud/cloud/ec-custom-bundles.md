...
Please refer to the [Extensions API reference](https://www.elastic.co/guide/en/cloud/current/Deployments_-_Extensions.html) for the complete set of HTTP methods and payloads.
