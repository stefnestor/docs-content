# Migrating data [ece-migrating-data]

If you want to move your existing Elasticsearch data into your new infrastructure, check out the [migration options](../../../manage-data/migrate.md#ece-migrate-data2). You’ll find instructions to guide you through:

* Migrating data [from its original source](../../../manage-data/migrate.md#ece-index-source)
* Reindexing data [from a remote Elasticsearch cluster](../../../manage-data/migrate.md#ece-reindex-remote)
...
* Restoring data [from a snapshot](../../../manage-data/migrate.md#ece-restore-snapshots)


## Migrate your Elasticsearch data [ece-migrate-data2]
...
### Before you begin [ece_before_you_begin_11]
...
### Index from the source [ece-index-source]
...
### Reindex from a remote cluster [ece-reindex-remote]

Through the Elasticsearch reindex API, you can connect your new Elastic Cloud Enterprise deployment remotely to your old Elasticsearch cluster. This pulls the data from your old cluster and indexes it into your new one. Reindexing essentially rebuilds the index from scratch and it can be more resource intensive to run.
...
4. From the **API Console** or in the Kibana Console app, create the destination index on Elastic Cloud Enterprise.
...
### Restore from a snapshot [ece-restore-snapshots]
...
5. Verify that the new index is restored in your Elastic Cloud Enterprise deployment with this query:
