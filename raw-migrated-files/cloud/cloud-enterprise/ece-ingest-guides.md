# Ingesting data from your application [ece-ingest-guides]
...
[Ingest data with Node.js on Elastic Cloud Enterprise](../../../manage-data/ingest/ingesting-data-from-applications/ingest-data-with-nodejs-on-elasticsearch-service.md)
:   Get Node.js application data securely into Elastic Cloud Enterprise, where it can then be searched and modified.

[Ingest data with Python on Elastic Cloud Enterprise](../../../manage-data/ingest/ingesting-data-from-applications/ingest-data-with-python-on-elasticsearch-service.md)
:   Get Python application data securely into Elastic Cloud Enterprise, where it can then be searched and modified.

[Ingest data from Beats to Elastic Cloud Enterprise with Logstash as a proxy](../../../manage-data/ingest/ingesting-data-from-applications/ingest-data-from-beats-to-elasticsearch-service-with-logstash-as-proxy.md)
...
[Ingest data from a relational database into Elastic Cloud Enterprise](../../../manage-data/ingest/ingesting-data-from-applications/ingest-data-from-relational-database-into-elasticsearch-service.md)
