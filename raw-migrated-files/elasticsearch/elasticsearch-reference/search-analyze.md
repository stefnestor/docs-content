...
It comes with a comprehensive set of [functions and operators](elasticsearch://reference/query-languages/esql/esql-functions-operators.md) for working with data and has robust integration with {{kib}}'s Discover, dashboards and visualizations.
