...
| [{{ilm-cap}}](asciidocalypse://docs/beats/docs/reference/filebeat/ilm.md) | Enabled by default although the Agent uses [data streams](asciidocalypse://docs/docs-content/docs/reference/ingestion-tools/fleet/data-streams.md). |
...
| [Autodiscover](asciidocalypse://docs/beats/docs/reference/filebeat/configuration-autodiscover.md) | Autodiscover is facilitated through [dynamic inputs](asciidocalypse://docs/docs-content/docs/reference/ingestion-tools/fleet/dynamic-input-configuration.md). {{agent}} does not support hints-based autodiscovery. |
