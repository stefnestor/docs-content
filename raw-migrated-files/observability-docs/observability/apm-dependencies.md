...
:alt: Dependencies view in the Applications UI in Kibana
:class: screenshot
:::
...
:alt: Dependencies drilldown view in the Applications UI in Kibana
:class: screenshot
:::
...
:alt: operations view in the Applications UI in Kibana
:class: screenshot
:::
...
:alt: operations detail view in the Applications UI in Kibana
:class: screenshot
:::
