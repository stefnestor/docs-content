...
* [What’s new in 9.0](https://www.elastic.co/guide/en/observability/current/whats-new.html)


## Get started with your use case [get-started-with-use-case]

Learn how to spin up a deployment of our hosted {{ess}} and use Elastic Observability to gain deeper insight into the behavior of your applications and systems.
