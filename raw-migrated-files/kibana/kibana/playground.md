...
* [Optimize model context](../../../solutions/search/rag/playground-context.md)
* [View and modify queries](../../../solutions/search/rag/playground-query.md)
* [Troubleshooting](../../../solutions/search/rag/playground-troubleshooting.md)
...
2. At least one **{{es}} index** with documents to search.
    ...
    * See [ingest data](../../../solutions/search/rag/playground.md#playground-getting-started-ingest) if you’d like to ingest sample data.
...
To get started with Playground, you need to create a [connector](../../../deploy-manage/manage-connectors.md) for your LLM provider. You can also connect to [locally hosted LLMs](../../../solutions/search/rag/playground.md#playground-local-llms) which are compatible with the OpenAI API, by using the OpenAI connector.
...
::::{tip}
Learn more about the underlying {{es}} queries used to search your data in [View and modify queries](../../../solutions/search/rag/playground-query.md)
