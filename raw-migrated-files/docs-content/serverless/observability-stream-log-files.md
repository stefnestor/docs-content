...
If you’re still running into issues, refer to [{{agent}} troubleshooting](../../../troubleshoot/ingest/fleet/common-problems.md) and [Configure standalone Elastic Agents](https://www.elastic.co/guide/en/fleet/current/elastic-agent-configuration.html).
