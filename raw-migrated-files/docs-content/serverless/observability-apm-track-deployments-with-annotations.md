# Track deployments with annotations [observability-apm-track-deployments-with-annotations]

::::{admonition} Required role
:class: note

The **Admin** role or higher is required to create and manage annotations. To learn more, refer to [Assign user roles and privileges](../../../deploy-manage/users-roles/cloud-organization/user-roles.md#general-assign-user-roles).

::::


:::{image} ../../../images/serverless-apm-transaction-annotation.png
