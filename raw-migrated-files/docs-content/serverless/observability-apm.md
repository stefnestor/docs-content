# Application performance monitoring (APM) [observability-apm]
...
## Give Elastic APM a try [observability-apm-give-elastic-apm-a-try] 

Ready to give Elastic APM a try? See [Get started with traces and APM](../../../solutions/observability/apps/get-started-with-apm.md).
