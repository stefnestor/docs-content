---
navigation_title: "Visualize alerts"
---
...
To reset a view to default settings, hover over it and click the options menu (![More actions](../../../images/serverless-boxesHorizontal.svg "")) that appears, then select **Reset group by fields**.
...
Click the collapse icon (![Markdown](../../../images/serverless-arrowDown.svg "")) to minimize the visualization section and display a summary of key information instead.
