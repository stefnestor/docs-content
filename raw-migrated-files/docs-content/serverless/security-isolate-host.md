# Isolate a host [security-isolate-host]
...
* Host isolation requires the Endpoint Protection Complete [project feature](../../../deploy-manage/deploy/elastic-cloud/project-settings.md).
...
:::{image} ../../../images/serverless--management-admin-isolated-host.png
...
1. Open a detection alert:
    ...
    * From the Alerts table or Timeline: Click **View details** (![View details](../../../images/serverless-expand.svg "")).
...
1. Find **Endpoints** in the navigation menu or use the global search field, then either:
...
::::{note}
The response console requires the Endpoint Protection Complete [project feature](../../../deploy-manage/deploy/elastic-cloud/project-settings.md).
...
::::{note}
The host isolation endpoint response action requires the Endpoint Protection Complete [project feature](../../../deploy-manage/deploy/elastic-cloud/project-settings.md).
...
2. Click the **Response action** field, then select **Isolate**.
3. Enter a comment describing why you’re isolating the host (optional).
...
:::{image} ../../../images/serverless--management-admin-host-isolated-notif.png
...
:::{image} ../../../images/serverless--management-admin-host-released-notif.png
