...
::::{important}
By default, Attack Discovery analyzes up to 100 alerts within this timeframe, but you can expand this up to 500 by clicking the settings icon (![Settings icon](../../../images/serverless-gear.svg "")) next to the model selection menu and adjusting the **Alerts** slider. Note that sending more alerts than your chosen LLM can handle may result in an error.
::::
...
* Hover over an entity’s name to either add the entity to Timeline (![Add to timeline icon](../../../images/serverless-timelineWithArrow.svg "")) or copy its field name and value to the clipboard (![Copy to clipboard icon](../../../images/serverless-copyClipboard.svg "")).
