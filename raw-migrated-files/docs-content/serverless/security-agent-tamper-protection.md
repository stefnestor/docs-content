# Prevent {{agent}} uninstallation [security-agent-tamper-protection]
...
* Agent tamper protection requires the Endpoint Protection Complete [project feature](../../../deploy-manage/deploy/elastic-cloud/project-settings.md).
...
:::{image} ../../../images/serverless-agent-tamper-protection.png
