# Enable access for macOS Monterey [security-install-endpoint-manually]
...
:::{image} ../../../images/serverless--getting-started-install-endpoint-system-ext-blocked.png
:alt:  getting started install endpoint system ext blocked
:class: screenshot
:::
...
2. In the lower-left corner of the **Security & Privacy** pane, click the **Lock button**, then enter your credentials to authenticate.
    ...
    :::{image} ../../../images/serverless--getting-started-fda-lock-button.png
    :alt:  getting started fda lock button
    :class: screenshot
    :::

3. Click **Allow** to allow the {{elastic-endpoint}} system extension to load.

    :::{image} ../../../images/serverless--getting-started-install-endpoint-allow-system-ext.png
    :alt:  getting started install endpoint allow system ext
    :class: screenshot
    :::
...
:::{image} ../../../images/serverless--getting-started-install-endpoint-filter-network-content.png
:alt:  getting started install endpoint filter network content
:class: screenshot
:::
...
2. Select **Security and Privacy**.
    ...
    :::{image} ../../../images/serverless--getting-started-fda-sec-privacy-pane.png
    :alt:  getting started fda sec privacy pane
    :class: screenshot
    :::
...
4. From the left pane, select **Full Disk Access**.
    ...
    :::{image} ../../../images/serverless--getting-started-fda-select-fda.png
...
6. In the **Privacy** tab,  confirm that `ElasticEndpoint` AND `co.elastic.systemextension` are selected to properly enable Full Disk Access.
    ...
    :::{image} ../../../images/serverless--getting-started-fda-select-endpoint-ext.png
    :alt:  getting started fda select endpoint ext
    :class: screenshot
    :::
