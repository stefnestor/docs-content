...
::::{note}
These fields are part of the [Elastic Common Schema (ECS)](asciidocalypse://docs/ecs/docs/reference/ecs/index.md). The ECS defines a common set of fields that you can use across your project when storing data, including log and metric data.
