# Create and manage shared exception lists [security-shared-exception-lists]
...
2. Do one of the following:
    ...
    * Find the shared exception list you want to assign to rules, then from the **More actions** menu (![Actions menu](../../../images/serverless-boxesHorizontal.svg "")), select **Link rules**.
...
5. (Optional) To verify that the shared exception list was added to the rules you selected:
    ...
    3. Navigate to the exception items that are included in the shared exception list. Click the **Affects shared list** link to view the associated shared exception lists.
        ...
        :::{image} ../../../images/serverless--detections-associated-shared-exception-list.png
...
:::{image} ../../../images/serverless--detections-view-filter-shared-exception.png
:alt: Associated shared exceptions
:class: screenshot
:::
...
:::{image} ../../../images/serverless--detections-actions-exception-list.png
