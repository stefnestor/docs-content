...
1. Find **Blocklist** in the navigation menu or use the global search field.
...
:::{image} ../../../images/serverless--management-admin-blocklist.png
:alt:  management admin blocklist
:class: screenshot
:::
...
1. Click the actions menu (![Actions menu icon](../../../images/serverless-boxesHorizontal.svg "")) for the blocklist entry you want to edit, then select **Edit blocklist**.
...
1. Click the actions menu (![Actions menu icon](../../../images/serverless-boxesHorizontal.svg "")) for the blocklist entry you want to delete, then select **Delete blocklist**.
