---
navigation_title: "File system monitoring (Linux)"
---

# Configure Linux file system monitoring [security-linux-file-monitoring]
...
2. If you have access to the endpoint, run `findmnt -o FSTYPE -T <file path>` to return the file system. For example:
