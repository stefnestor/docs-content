...
3. Use the [bulk API]({{es-apis}}operation/operation-bulk) to index the data to a matching stream:
...
4. Use the [cat indices API]({{es-apis}}operation/operation-cat-indices) to verify the data was indexed:
