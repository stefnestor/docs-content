...
You must have an appropriate license to initiate {{ml-jobs-cap}} on datasets from remote clusters accessed through Cross-Cluster Search (CCS). Refer to the [Subscriptions]([https://www.elastic.co/subscriptions](https://www.elastic.co/subscriptions) page for details on features available with different subscription levels.
