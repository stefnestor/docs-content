...
# {{fleet}}-managed {{agent}} connectivity using a proxy server [fleet-agent-proxy-managed]
...
In this scenario {{fleet-server}} and {{es}} are deployed in {{ecloud}} and reachable on port 443.
