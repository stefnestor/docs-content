...
# Standalone {{agent}} connectivity using a proxy server [fleet-agent-proxy-standalone]
...
For more information, refer to [Configure standalone {{agents}}s](/reference/fleet/configure-standalone-elastic-agents.md).
