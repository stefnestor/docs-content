...
description: Centrally monitor {{agent}} and OpenTelemetry Collectors in Fleet using OpAMP.
type: overview
applies_to:
  stack: preview 9.4+
  serverless: preview
