...
Refer to [Voice and tone](./voice-tone.md) for the complete guidelines.
...
Refer to [Accessibility and inclusivity](./accessibility.md) for the complete guidelines.
...
Refer to [Grammar and spelling](./grammar-spelling.md) for the complete guidelines.
...
Refer to [Formatting](./formatting.md) for the complete guidelines.
...
Refer to [Writing about the UI](./ui-writing.md) for the complete guidelines.
...
Refer to [Word choice](./word-choice.md) for the complete guidelines.

## Automated style checking

The [Vale linter](/contribute-docs/vale-linter.md) can help you check for style issues while writing documentation. Vale automatically flags common style guide violations, so you can catch and fix issues before publishing.
